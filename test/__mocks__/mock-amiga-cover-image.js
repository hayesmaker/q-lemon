module.exports = {
  data: `<html><head>
	<title>Cannon Fodder - Amiga Game Box Scan - Front</title>
	<meta name="description" content="Box scan in high quality for the Amiga game Cannon Fodder by Virgin Interactive.">
	<meta name="keywords" content="box scan, cover scan, amiga games, amiga game, Cannon Fodder">
...
<tr>
	<td colspan="3"><img src="/images/tables/border_small_bottom.gif" width="238" height="6" alt="" border="0"></td>
		...
		<div id="bug1" style="position:absolute; z-index:20; top:66px; left:45px;">
	<img src="/images/bugs/3.gif" width="44" height="15" border="0">
	</div>
		<div id="bug2" style="position:absolute; z-index:20; top:66px; left:584px;">
	<img src="/images/bugs/1.gif" width="44" height="15" border="0">
	</div>

<style type="text/css">
a.bluelink {color: #162770;}
a.bluelink:visited {color: #162770;}
a.bluelink:hover {color: #1756b5;}
a.bluelink:active {color: #1756b5;}
</style>

<table border="0" cellspacing="0" cellpadding="0" width="721">
<tbody><tr>
	<td colspan="3"><img src="/images/tables/boxes_wide.gif" width="721" height="24" alt="Box" border="0"></td>
</tr>
<tr>
	<td background="/images/tables/border_left.gif" width="4"><img src="/images/dot.gif" width="4" height="1" border="0"></td>
	<td bgcolor="#E1E7F6">

	<table bgcolor="#BECBEA" width="100%" border="0" cellspacing="3" cellpadding="0" background="/images/reviews/middle_back.gif" style="border-bottom-color: 2B4EA2; border-bottom-style: solid; border-bottom-width: 1px;" height="23">
	<tbody><tr>
	<td width="40%" style="padding-left: 4px;">
	<strong class="textHeader"><a href="/games/details.php?id=215" title="View detailed info about this game" class="bluelink">Cannon Fodder</a></strong>
	</td><td align="center" width="20%"><b><a href="/games/box.php?id=169&amp;type=02"><img src="/images/icons/camera_small.png" width="12" height="9" alt="" border="0" hspace="3">Show Back of Box</a></b></td><td align="right" width="40%" style="padding-right: 4px; "><b class="textHeader"><strong><a href="/games/list.php?list_year=1993" class="bluelink" title="List games published in 1993">1993</a>,  <a href="/games/list.php?list_publisher=Virgin Interactive" class="bluelink" title="List games published by Virgin Interactive">Virgin Interactive</a></strong></b></td>	</tr>
	</tbody></table>
	<img name="box" src="/games/boxes/full/cannon_fodder_01.jpg" border="0" width="713" height="923" alt="Cannon Fodder - Amiga Box Scan - Front"><br>	<table border="0" cellspacing="0" cellpadding="4" width="100%" background="/images/reviews/bottom_back.gif" bgcolor="#BECBEA">
	<tbody><tr>
	<td style="padding-top:6px;"><a href="javascript:history.go(-1)"><img src="/images/buttons/back.gif" width="52" height="20" alt="" title="Go Back!" border="0"></a></td>
	<td style="padding-top:6px;" align="right">Scanned by <strong>Predseda</strong> for Lemon Amiga.</td>
	</tr>
	</tbody></table>
...
<tr>
	<td colspan="3"><img src="/images/tables/border_bottom_wide.gif" width="721" height="6" alt="" border="0"></td>
</tr>
</tbody></table>

<div class="footerText" align="center">A sister site to <a href="https://www.lemon64.com" target="blank" class="footerLink">Lemon64</a>. Made in Sweden by <a href="/help/kim-lemon.php" class="footerLink">Kim Lemon</a> 2004-2019.<br>
